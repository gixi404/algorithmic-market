...
function MediaPlayer() {
  ...
  function handleChangeURL(classId) {
    ...
    /*switch (pathname) {
      ...
      case "classTwo":
        setClassData({
          classId: myCourses[0].classes[1].id,
          className: myCourses[0].classes[1].name,
          classURL: myCourses[0].classes[1].URL,
        });
        break;
      case "classThree":
        setClassData({
          classId: myCourses[0].classes[2].id,
          className: myCourses[0].classes[2].name,
          classURL: myCourses[0].classes[2].URL,
        });
        break;
      default:
        setClassData({
